            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @can('create', App\Models\Curriculum::class)
                        <div class="my-2">
                            <x-button :href="route('curriculum.create')" type="create">
                                <i class="fa fa-plus text-sm"></i> {{ __('Create new curriculum.') }}
                            </x-button>
                        </div>
                    @endcan
                                ...
                                <tr>
                                    ...
                                    <td class="py-4 text-center">
                                        ...
                                        @can('update', $curriculum)
                                            <x-button :href="route('curriculum.edit',['curriculum' => $curriculum])" type="edit"><i class="fa-light fa-pen"></i></x-button>
                                        @endcan
                                        @can('delete', $curriculum)
                                            ...
                                            " action="{{route('curriculum.destroy', ['curriculum' => $curriculum])}}" method="post" class="inline-block bg-red-500 hover:bg-red-400 hover:text-white hover:cursor-pointer dark:bg-red-800 dark:hover:bg-red-700 rounded-xl p-2 px-3">
                                                @csrf
                                                @method('delete')
